...
function rr_scripts() {
	...
	wp_enqueue_style( 'ruslan-theme-bootstrap', get_template_directory_uri() . "/assets/plugins/bootstrap/css/bootstrap.min.css", array(), _S_VERSION );
	wp_enqueue_style( 'ruslan-theme-style', get_template_directory_uri() . "/assets/css/style.css", [
		'ruslan-theme-bootstrap'
	], _S_VERSION );


	wp_enqueue_script( 'ruslan-theme-app', get_template_directory_uri() . '/assets/js/app.js', [
		'rr-jquery', 'rr-bootstrap'
	], _S_VERSION, true );
	wp_enqueue_script( 'rr-jquery', get_template_directory_uri() . '/assets/plugins/jquery/jquery.min.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'rr-bootstrap', get_template_directory_uri() . '/assets/plugins/bootstrap/js/bootstrap.min.js', [
		'rr-jquery'
	], _S_VERSION, true );
...
require get_template_directory() . '/inc/cpt/cpt-article.php';
